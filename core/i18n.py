...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "pricing.lead": {
        "az": "1 ay pulsuz başlayın. Gizli ödəniş yoxdur. İstədiyiniz vaxt ləğv edin.",
        "en": "Start free for 1 month. No hidden fees. Cancel anytime.",
        "ru": "Начните бесплатно на 1 месяц. Без скрытых платежей. Отмена в любой момент.",
    },
    "pricing.cta": {"az": "Başla", "en": "Get started", "ru": "Начать"},
    "pricing.badge_free": {"az": "1 AY PULSUZ", "en": "1 MONTH FREE", "ru": "1 МЕСЯЦ БЕСПЛАТНО"},
    ...
    "pricing.std.extra": {
        "az": "Əlavə mesaj: 0.04 AZN",
        "en": "Extra messages: 0.04 AZN",
        "ru": "Доп. сообщения: 0.04 AZN",
    },
    ...
    "pricing.biz.extra": {
        "az": "Əlavə mesaj: 0.03 AZN",
        "en": "Extra messages: 0.03 AZN",
        "ru": "Доп. сообщения: 0.03 AZN",
    },
    ...
    "pricing.biz.f4": {"az": "API inteqrasiyası", "en": "API integration", "ru": "API-интеграция"},
    "pricing.biz.f5": {"az": "Prioritet dəstək", "en": "Priority support", "ru": "Приоритетная поддержка"},
    "pricing.biz.f6": {"az": "Daha sürətli cavab limiti", "en": "Higher reply throughput", "ru": "Выше лимит скорости ответов"},
        ...
        "pricing_plans": [
            {
                ...
                "extra": t["pricing.std.extra"],
                "badge": t["pricing.badge_free"],
                "featured": False,
                "features": [
                    t["pricing.std.f1"],
                    t["pricing.std.f2"],
