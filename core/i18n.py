...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "pricing.title": {
        "az": "Sadə, şəffaf qiymət",
        "en": "Simple, transparent pricing",
        "ru": "Простые и прозрачные цены",
    },
    "pricing.cta": {"az": "Başla", "en": "Get started", "ru": "Начать"},
    "pricing.badge_popular": {"az": "ƏN POPULYAR", "en": "MOST POPULAR", "ru": "САМЫЙ ПОПУЛЯРНЫЙ"},
    "pricing.per_mo": {"az": "AZN/ay", "en": "AZN/mo", "ru": "AZN/мес"},
    "pricing.std.name": {"az": "Standart", "en": "Standard", "ru": "Стандарт"},
    "pricing.std.desc": {
        "az": "Kiçik bizneslər və test üçün.",
        "en": "Best for small businesses and testing.",
        "ru": "Для малого бизнеса и тестирования.",
    },
    "pricing.std.f1": {"az": "2,000 AI mesaj / ay", "en": "2,000 AI messages / mo", "ru": "2 000 AI-сообщений / мес"},
    "pricing.std.f2": {"az": "Instagram DM avtomatlaşdırma", "en": "Instagram DM automation", "ru": "Автоответы Instagram DM"},
    "pricing.std.f3": {"az": "Biznes məlumat bazası", "en": "Knowledge Base", "ru": "База знаний"},
    "pricing.std.f4": {"az": "Potensial müştəri tutma", "en": "Lead capture", "ru": "Захват лидов"},
    "pricing.std.f5": {"az": "CRM Dashboard", "en": "CRM Dashboard", "ru": "CRM Dashboard"},
    "pricing.std.f6": {"az": "Analitika paneli", "en": "Analytics panel", "ru": "Панель аналитики"},
    "pricing.biz.name": {"az": "Biznes", "en": "Business", "ru": "Бизнес"},
    "pricing.biz.desc": {
        "az": "Artan komandalar və inteqrasiyalar üçün.",
        "en": "For growing teams and integrations.",
        "ru": "Для растущих команд и интеграций.",
    },
    "pricing.biz.f1": {"az": "6,000 AI mesaj / ay", "en": "6,000 AI messages / mo", "ru": "6 000 AI-сообщений / мес"},
    "pricing.biz.f2": {"az": "Standart-dakı bütün imkanlar", "en": "Everything in Standard", "ru": "Всё из Стандарт"},
    "pricing.biz.f3": {"az": "CRM Dashboard", "en": "CRM Dashboard", "ru": "CRM Dashboard"},
    "pricing.biz.f4": {"az": "CRM webhook inteqrasiyası", "en": "CRM webhook integration", "ru": "Webhook-интеграция с CRM"},
    "pricing.biz.f5": {"az": "Prioritet dəstək", "en": "Priority support", "ru": "Приоритетная поддержка"},
    ...
    "dash.integrations": {"az": "İnteqrasiyalar", "en": "Integrations", "ru": "Интеграции"},
    ...
    "int.title": {"az": "İnteqrasiyalar", "en": "Integrations", "ru": "Интеграции"},
    "int.lead": {
        "az": "Yeni potensial müştəriləri birbaşa öz CRM-inizə webhook ilə göndərin — əlavə proqram haqqı yoxdur.",
        "en": "Send new leads directly to your CRM via webhooks — no third-party fees.",
        "ru": "Отправляйте лиды напрямую в ваш CRM через webhook — без сторонних сервисов.",
    },
    "int.locked_title": {
        "az": "Biznes planı tələb olunur",
        "en": "Business plan required",
        "ru": "Нужен тариф Бизнес",
    },
    "int.locked_body": {
        "az": "CRM webhook inteqrasiyası yalnız Biznes planında aktivdir.",
        "en": "CRM webhook integration is available on the Business plan.",
        "ru": "Webhook-интеграция с CRM доступна на тарифе Бизнес.",
    },
    "int.locked_hint": {
        "az": "Biznes planı üçün bizimlə WhatsApp-da əlaqə saxlayın.",
        "en": "Contact us on WhatsApp to unlock the Business plan.",
        "ru": "Напишите нам в WhatsApp, чтобы открыть тариф Бизнес.",
    },
    "int.upgrade": {"az": "WhatsApp-da yazın", "en": "Message on WhatsApp", "ru": "Написать в WhatsApp"},
    "int.how_title": {"az": "Necə işləyir", "en": "How it works", "ru": "Как это работает"},
    "int.how_1": {
        "az": "CRM-inizdə (və ya backend-inizdə) HTTPS webhook URL yaradın.",
        "en": "Create an HTTPS webhook URL in your CRM or backend.",
        "ru": "Создайте HTTPS webhook URL в CRM или на бэкенде.",
    },
    "int.how_2": {
        "az": "URL-i aşağıya əlavə edin və secret ilə imzanı yoxlayın.",
        "en": "Paste the URL below and verify the HMAC signature with the secret.",
        "ru": "Вставьте URL ниже и проверяйте HMAC-подпись с секретом.",
    },
    "int.how_3": {
        "az": "Yeni lead yarananda AI Assistant JSON POST göndərir.",
        "en": "When a lead is created, AI Assistant POSTs JSON to your URL.",
        "ru": "При создании лида AI Assistant отправляет JSON POST на ваш URL.",
    },
    "int.headers_hint": {
        "az": "Header-lər: X-AI-Assistant-Event, X-AI-Assistant-Signature (sha256=...), X-AI-Assistant-Delivery.",
        "en": "Headers: X-AI-Assistant-Event, X-AI-Assistant-Signature (sha256=...), X-AI-Assistant-Delivery.",
        "ru": "Заголовки: X-AI-Assistant-Event, X-AI-Assistant-Signature (sha256=...), X-AI-Assistant-Delivery.",
    },
    "int.add_title": {"az": "Webhook əlavə et", "en": "Add webhook", "ru": "Добавить webhook"},
    "int.name": {"az": "Ad", "en": "Name", "ru": "Название"},
    "int.url": {"az": "Webhook URL", "en": "Webhook URL", "ru": "Webhook URL"},
    "int.events": {"az": "Hadisələr", "en": "Events", "ru": "События"},
    "int.save": {"az": "Yadda saxla", "en": "Save", "ru": "Сохранить"},
    "int.endpoints": {"az": "Aktiv endpoint-lər", "en": "Your endpoints", "ru": "Ваши endpoint’ы"},
    "int.secret": {"az": "Secret", "en": "Secret", "ru": "Секрет"},
    "int.status": {"az": "Status", "en": "Status", "ru": "Статус"},
    "int.active": {"az": "Aktiv", "en": "Active", "ru": "Активен"},
    "int.inactive": {"az": "Sönülü", "en": "Inactive", "ru": "Выключен"},
    "int.test": {"az": "Test", "en": "Test", "ru": "Тест"},
    "int.enable": {"az": "Aktiv et", "en": "Enable", "ru": "Включить"},
    "int.disable": {"az": "Söndür", "en": "Disable", "ru": "Выключить"},
    "int.delete": {"az": "Sil", "en": "Delete", "ru": "Удалить"},
    "int.empty": {
        "az": "Hələ webhook yoxdur — yuxarıdakı formadan əlavə edin.",
        "en": "No webhooks yet — add one with the form above.",
        "ru": "Пока нет webhook — добавьте через форму выше.",
    },
    "int.deliveries": {"az": "Son göndərişlər", "en": "Recent deliveries", "ru": "Последние доставки"},
    "int.deliveries_empty": {
        "az": "Hələ göndəriş yoxdur.",
        "en": "No deliveries yet.",
        "ru": "Пока нет доставок.",
    },
    "int.col_time": {"az": "Vaxt", "en": "Time", "ru": "Время"},
    "int.col_event": {"az": "Hadisə", "en": "Event", "ru": "Событие"},
    "int.col_endpoint": {"az": "Endpoint", "en": "Endpoint", "ru": "Endpoint"},
    "int.col_code": {"az": "HTTP", "en": "HTTP", "ru": "HTTP"},
    "int.retry": {"az": "Yenidən", "en": "Retry", "ru": "Повтор"},
...
def landing_payload(lang: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "industries": [
            {"key": "construction", "label": t["ind.construction"]},
            {"key": "medical", "label": t["ind.medical"]},
            {"key": "restaurant", "label": t["ind.restaurant"]},
            {"key": "estate", "label": t["ind.estate"]},
            {"key": "beauty", "label": t["ind.beauty"]},
            {"key": "legal", "label": t["ind.legal"]},
            {"key": "education", "label": t["ind.education"]},
        ],
